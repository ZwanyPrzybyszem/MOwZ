...
namespace MOwZProject.Controllers
{
    ...
    public class ProblemController : Controller
    {
        ...
        public ActionResult GanttChart(string tasks, string starts, string stops, string color)
        {
            ...
            Chart chart = new Chart();
            chart.ChartAreas.Add(new ChartArea());
            int tempw = ((stopsTab.Max() / min) * 40) > 1200 ? 1200 : ((stopsTab.Max() / min) * 40) ;
            if (tempw < 100)
            {
                chart.Width = 100;
            }
            ...
            chart.Height = Array.ConvertAll(tasks.Split(' '), Int32.Parse).Length * 8 < 100 ? 100 : Array.ConvertAll(tasks.Split(' '), Int32.Parse).Length * 8;
            chart.Series.Add(new Series("Data"));
